    ...
    <div class="main-container">
        <div class="content">
            ...
            <div class="calculator-block">
                ...
                <form method="post" id="lpForm">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn-solve btn-export" onclick="alert('Результат сохранен в data/results/')">Сохранить результат</button>
                        % end
                    </div>
                </form>
            ...
            <div id="step1_block" class="step" style="display: none;">
                ...
                <img src="{{theory['image']}}" alt="Симплекс-метод шаг 1" style="max-width:100%; border-radius:8px; margin-top:1rem;">
            </div>
            ...
            <div id="step2_block" class="step" style="display: none;">
                ...
                <img src="{{theory['image']}}" alt="Симплекс-метод шаг 2" style="max-width:100%; border-radius:8px; margin-top:1rem;">
            </div>
